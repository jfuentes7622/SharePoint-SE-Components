define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "isUndefinedValidateError": "[!!--##***Ťĥě vàļűȅ ƒőŗ \"{0}\" mųśţ ŉŏŧ ƅȇ ūņđęƒĭŉęď##--!!]",
      "isEmptyStringValidateError": "[!!--##***Ţĥȇ vàĺůȇ ƒơř \"{0}\" můŝţ ńơť ƀě àņ ėmƿţȳ ŝŧŕįŉĝ##--!!]",
      "isDisposedValidateError": "[!!--##***Ťħė \"{0}\" ōƃĴȅċŧ čȁŉƞőţ ƃė ūšęđ ƃĕċȁūšē ĩŧ ħàś ƀȇĕņ đıśƿŏśěď.##--!!]",
      "invalidVersionStringError": "[!!--##***Īƞvåłĩď vėřśĩōƞ ŝťŗĩŉġ: \"{0}\"##--!!]",
      ...
      "serviceScopeConsumingDuringAutoCreation": "[!!--##***Ćàŋŉőŧ ćőńśůmē şęŗvıčĕŝ đūřĩŉģ ŜěŕvīċėŚćőƥȇ àųţōċŗěáţıōň##--!!]",
      "serviceScopeAlreadyFinishedError": "[!!--##***Ťħě ŜęŕvĭčėŜĉơƥȇ ış ãļŕēâďƴ ƒīņĭšħȇď##--!!]",
      "serviceScopeProvideServiceAfterFinishedError": "[!!--##***Ĉăńňőť řēġĭşŧěŗ śĕŕvĭċė Ƅęċȁũšĕ ţħē ŝĉŏƥȅ ĭś ăłŗěäđɏ ƒıŉĭşħȇď##--!!]",
      "serviceScopeProvideServiceThatAlreadyExists": "[!!--##***Ťħě šĕŕvĩčĕ ķȇɏ \"{0}\" ĥȁş áļŗēąđɏ ƃęěŉ ŗȅģīŝŧēřěđ įň ťĥĩš šċơƿė##--!!]",
