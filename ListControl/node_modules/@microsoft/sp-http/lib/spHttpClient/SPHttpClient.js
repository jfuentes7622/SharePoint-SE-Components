...
var SPHttpClient = (function () {
    ...
    SPHttpClient.prototype._fetchWithInstrumentation = function (configuration, request) {
        var _this = this;
        var qosMonitor = new _QosMonitor(SPHttpClient_1._className);
        return SPHttpClientHelper.fetchCore(configuration, request, this._serviceScope, this._fetchProvider, SPHttpClient_1._className).then(function (response) {
    ...
    SPHttpClient.serviceKey = ServiceKey.create('sp-http:SPHttpClient', SPHttpClient_1);
