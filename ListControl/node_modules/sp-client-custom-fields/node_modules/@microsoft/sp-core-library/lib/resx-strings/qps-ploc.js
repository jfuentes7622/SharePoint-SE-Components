define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "serviceScopeConsumingBeforeFinished": "[!!--##***Ċâŉňŏŧ ćōńśųmė śȇŗvīčȇş ƀęćȃűšě ŧĥȅ śčŏƿȇ ıŝ ŉŏť ƒĭŉışĥēď ɏȅť##--!!]",
      ...
      "serviceScopeProvideServiceAfterFinishedError": "[!!--##***Ćáňŉŏť ŗȅğīšţēŗ şěřvĩčȇ ɓȅčâũśȇ ŧĥȇ şĉōƿĕ ıś ãłŕȇȃđƴ ƒıŉĩšĥęđ##--!!]",
      "serviceScopeProvideServiceThatAlreadyExists": "[!!--##***Ŧħė śĕŕvįčě ĸȅŷ \"{0}\" ħȃś àĺŗěåđŷ Ƃȇēŉ řȇĝĩšťȇŕȇď įŉ ŧĥįŝ ščőƿȅ##--!!]",
