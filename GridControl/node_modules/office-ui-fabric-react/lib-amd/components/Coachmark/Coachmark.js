    ...
    var Coachmark = /** @class */ (function (_super) {
        ...
        function Coachmark(props) {
            ...
            _this._openCoachmark = function () {
                ...
                _this._translateAnimationContainer.value && _this._translateAnimationContainer.value.addEventListener('animationstart', function () {
                    if (_this.props.onAnimationOpenStart) {
                        _this.props.onAnimationOpenStart();
                    }
                });
                _this._translateAnimationContainer.value && _this._translateAnimationContainer.value.addEventListener('animationend', function () {
                    ...
                    React.createElement("div", { className: classNames.translateAnimationContainer, ref: this._translateAnimationContainer },
                        React.createElement("div", { className: classNames.scaleAnimationLayer },
                            React.createElement("div", { className: classNames.rotateAnimationLayer },
                                this._positioningContainer.value && React.createElement(Beak_1.Beak, { width: beakWidth, height: beakHeight, left: this.state.beakLeft, top: this.state.beakTop }),
        ...
        Coachmark.prototype.componentDidMount = function () {
            ...
            this._async.requestAnimationFrame((function () {
                if (_this._entityInnerHostElement.value && (_this.state.entityInnerHostRect.width + _this.state.entityInnerHostRect.width) === 0) {
                    ...
                    _this.setState({
                        isMeasuring: false,
                        entityInnerHostRect: {
                            width: _this._entityInnerHostElement.value.offsetWidth,
                            height: _this._entityInnerHostElement.value.offsetHeight
                        },
        ...
        Coachmark.prototype._addProximityHandler = function (mouseProximityOffset) {
            ...
            this._async.setTimeout(function () {
                if (_this._entityInnerHostElement.value) {
                    targetElementRect = _this._entityInnerHostElement.value.getBoundingClientRect();
                }
