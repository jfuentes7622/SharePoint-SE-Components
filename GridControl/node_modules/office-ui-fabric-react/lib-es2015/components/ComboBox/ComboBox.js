...
import { BaseComponent, divProperties, findIndex, getId, getNativeProps, customizable, css, createRef, shallowCompare } from '../../Utilities';
...
var ComboBox = /** @class */ (function (_super) {
    ...
    function ComboBox(props) {
        ...
        _this._onRenderContainer = function (props) {
            ...
            return (React.createElement(Callout, tslib_1.__assign({ isBeakVisible: false, gapSpace: 0, doNotLayer: false, directionalHint: 4 /* bottomLeftEdge */, directionalHintFixed: true }, calloutProps, { className: css(_this._classNames.callout, calloutProps ? calloutProps.className : undefined), target: _this._comboBoxWrapper.value, onDismiss: _this._onDismiss, onScroll: _this._onScroll, setInitialFocus: false, calloutWidth: useComboBoxAsMenuWidth && _this._comboBoxWrapper.value ?
