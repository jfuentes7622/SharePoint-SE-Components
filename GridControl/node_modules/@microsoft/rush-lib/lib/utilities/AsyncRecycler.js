...
class AsyncRecycler {
    ...
    moveFolder(folderPath) {
        ...
        Utilities_1.default.retryUntilTimeout(() => fsx.renameSync(folderPath, newFolderPath), maxWaitTimeMs, (e) => new Error(`Error: ${e}${os.EOL}Often this is caused by a file lock ` +
