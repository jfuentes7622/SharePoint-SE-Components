...
class ChangeManager {
     ...
     */
    load(changesPath, prereleaseToken = new PrereleaseToken_1.default(), includeCommitDetails = false) {
        this._allPackages = this._rushConfiguration.projectsByName;
        this._prereleaseToken = prereleaseToken;
        this._changeFiles = new ChangeFiles_1.default(changesPath);
        this._allChanges = PublishUtilities_1.default.findChangeRequests(this._allPackages, this._rushConfiguration, this._changeFiles, includeCommitDetails, this._prereleaseToken, this._lockStepProjectsToExclude);
        this._orderedChanges = PublishUtilities_1.default.sortChangeRequests(this._allChanges);
    }
    hasChanges() {
    ...
    apply(shouldCommit) {
        ...
        const updatedPackages = PublishUtilities_1.default.updatePackages(this._allChanges, this._allPackages, this._rushConfiguration, shouldCommit, this._prereleaseToken, this._lockStepProjectsToExclude);
    ...
    updateChangelog(shouldCommit) {
        ...
        if (!this._prereleaseToken.hasValue) {
            // Update changelogs.
            const updatedChangelogs = ChangelogGenerator_1.default.updateChangelogs(this._allChanges, this._allPackages, this._rushConfiguration, shouldCommit);
