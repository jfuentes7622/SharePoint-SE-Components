...
/* Excluded from this release type: _IColorPalette */

/**
 * @Copyright (c) Microsoft Corporation.  All rights reserved.
 *
 * @file Interface for components that can be set invisible
 */
declare interface IComponentVisible {
    setComponentVisibility(setVisible: boolean): void;
}

/* Excluded from this release type: IO365ShellRenderSettings */
...
/* Excluded from this release type: _ISuiteNavConfigurationData */

/* Excluded from this release type: ISuiteNavData */

/* Excluded from this release type: ISuiteNavLink */

/* Excluded from this release type: ISuiteNavManager */

/* Excluded from this release type: ISuiteNavManagerConfiguration */

/* Excluded from this release type: ISuiteNavModel */

/* Excluded from this release type: ISuiteNavOverrideStrings */
...
/* Excluded from this release type: _SuiteNavManagerConfiguration */
