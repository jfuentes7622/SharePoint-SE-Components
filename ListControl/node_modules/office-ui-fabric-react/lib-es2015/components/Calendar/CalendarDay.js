...
import { BaseComponent, css, getId, getRTL, getRTLSafeKeyCode } from '../../Utilities';
...
var CalendarDay = /** @class */ (function (_super) {
    ...
    CalendarDay.prototype._getWeeks = function (propsToUse) {
        ...
        var selectedDates = getDateRangeArray(selectedDate, dateRangeType, firstDayOfWeek, workWeekDays);
        if (dateRangeType !== DateRangeType.Day) {
