...
var ResizeGroupBase = /** @class */ (function (_super) {
    ...
    ResizeGroupBase.prototype._afterComponentRendered = function () {
        ...
        this._async.requestAnimationFrame(function () {
            ...
            if (_this.state.measureContainer && _this._root.value) {
                containerWidth = _this._root.value.getBoundingClientRect().width;
            }
            var nextState = _this._nextResizeGroupStateProvider.getNextState(_this.props, _this.state, function () { return _this._measured.value ? _this._measured.value.scrollWidth : 0; }, containerWidth);
            if (nextState) {
