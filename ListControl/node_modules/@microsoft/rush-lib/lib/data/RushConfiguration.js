...
class RushConfiguration {
    ...
    static loadFromConfigurationFile(rushJsonFilename) {
        ...
        if (expectedRushVersion && semver.valid(expectedRushVersion)) {
            ...
            if (semver.major(Rush_1.default.version) !== semver.major(expectedRushVersion)
                || semver.minor(Rush_1.default.version) !== semver.minor(expectedRushVersion)) {
                ...
                if (semver.lt(Rush_1.default.version, expectedRushVersion)) {
                    throw new Error(`Unable to load ${rushJsonBaseName} because its RushVersion is`
                        + ` ${rushConfigurationJson.rushVersion}, whereas @microsoft/rush-lib is version ${Rush_1.default.version}.`
