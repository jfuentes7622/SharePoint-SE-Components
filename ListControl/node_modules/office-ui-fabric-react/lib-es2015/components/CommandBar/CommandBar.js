...
var CommandBar = /** @class */ (function (_super) {
    ...
    function CommandBar(props) {
        ...
        _this._onContextMenuDismiss = function (ev) {
            var commandSurface = _this._commandSurface.value;
    ...
    CommandBar.prototype._renderItemInCommandBar = function (item, posInSet, setSize, expandedMenuItemKey, isFarItem) {
        ...
        if (item.href) {
            ...
            command = (React.createElement("a", tslib_1.__assign({}, getNativeProps(item, anchorProperties.concat(['disabled'])), { id: this._id + item.key, className: className, href: item.disabled ? undefined : item.href, onClick: this._onItemClick(item), title: '', "aria-disabled": item.inactive, "data-command-key": itemKey, "aria-haspopup": hasSubmenu(item), role: 'menuitem', "aria-label": ariaLabel, "aria-setsize": setSize, "aria-posinset": posInSet }),
            ...
            command = (React.createElement("button", tslib_1.__assign({}, getNativeProps(item, buttonProperties), { id: this._id + item.key, className: className, onClick: this._onItemClick(item), title: '', "aria-disabled": item.inactive, "data-command-key": itemKey, "aria-haspopup": hasSubmenu(item), "aria-expanded": hasSubmenu(item) ? expandedMenuItemKey === item.key : undefined, role: 'menuitem', "aria-label": ariaLabel, "aria-setsize": setSize, "aria-posinset": posInSet }),
                (hasIcon) ? this._renderIcon(item) : (null),
                isNameVisible && (React.createElement("span", { className: css('ms-CommandBarItem-commandText', styles.itemCommandText) }, item.name)),
                hasSubmenu(item) ? (React.createElement(Icon, { className: css('ms-CommandBarItem-chevronDown', styles.itemChevronDown), iconName: 'ChevronDown' })) : (null)));
        }
        else {
            // Allow the disabled property on div elements for commandbar
            command = (React.createElement("div", tslib_1.__assign({}, getNativeProps(item, divProperties.concat(['disabled'])), { id: this._id + item.key, className: className, title: '', "aria-disabled": item.inactive, "data-command-key": itemKey, "aria-haspopup": hasSubmenu(item), "aria-label": ariaLabel, "aria-setsize": setSize, "aria-posinset": posInSet }),
                (hasIcon) ? this._renderIcon(item) : (null),
