...
describe('ChangeManager', () => {
    ...
    it('can update explicit cyclic dependency', () => {
        ...
        chai_1.expect(changeManager.allPackages.get('cyclic-dep-explicit-1').packageJson.dependencies['cyclic-dep-explicit-2'])
            .equals('>=1.0.0 <2.0.0', 'the "cyclic-dep-explicit-2" dependency in "cyclic-dep-explicit-1" should not be updated');
        chai_1.expect(changeManager.allPackages.get('cyclic-dep-explicit-2').packageJson.version).equals('1.0.0', 'cyclic-dep-explicit-2 should not have patch version update.');
