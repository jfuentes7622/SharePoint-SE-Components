...
describe('updateChangelogs', () => {
    ...
    it('skips changes logs if the project version is not changed.', () => {
        ...
        const updatedChangeLogs = ChangelogGenerator_1.default.updateChangelogs(changeHash, rushConfiguration.projectsByName, rushConfiguration, false);
    ...
    it('writes changelog for hotfix changes', () => {
        ...
        const updatedChangeLogs = ChangelogGenerator_1.default.updateChangelogs(changeHash, rushConfiguration.projectsByName, rushConfiguration, false);
        chai_1.expect(updatedChangeLogs.length).eqls(2);
        chai_1.expect(updatedChangeLogs[0].name).eqls('a');
        chai_1.expect(updatedChangeLogs[1].name).eqls('b');
    });
