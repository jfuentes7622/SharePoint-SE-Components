    ...
    var Dropdown = /** @class */ (function (_super) {
                ...
                switch (ev.which) {
                    case 38 /* up */:
                        if (ev.altKey || ev.metaKey) {
                            ...
                            if (_this._host.value) {
                                elementToFocus = Utilities_1.getLastFocusable(_this._host.value, _this._host.value.lastChild, true);
                            }
                        }
                        break;
                    ...
                    case 40 /* down */:
                        if (_this._host.value) {
                            elementToFocus = Utilities_1.getFirstFocusable(_this._host.value, _this._host.value.firstChild, true);
                        }
                        break;
                    case 27 /* escape */:
                        _this.setState({ isOpen: false });
        ...
        Dropdown.prototype.render = function () {
            ...
            return (React.createElement("div", { className: Utilities_1.css('ms-Dropdown-container') },
                ...
                React.createElement("div", tslib_1.__assign({ "data-is-focusable": !disabled, ref: this._dropDown, id: id, tabIndex: disabled ? -1 : 0, "aria-expanded": isOpen ? 'true' : 'false', role: 'listbox', "aria-autocomplete": 'none', "aria-live": disabled || isOpen ? 'off' : 'assertive', "aria-label": ariaLabel, "aria-describedby": id + '-option', "aria-activedescendant": isOpen && selectedIndices.length === 1 && selectedIndices[0] >= 0 ? (this._id + '-list' + selectedIndices[0]) : undefined, "aria-disabled": disabled, "aria-owns": isOpen ? id + '-list' : undefined }, divProps, { className: Utilities_1.css('ms-Dropdown', styles.root, className, isOpen && 'is-open', disabled && ('is-disabled ' + styles.rootIsDisabled), required && 'is-required'), onBlur: this._onDropdownBlur, onKeyDown: this._onDropdownKeyDown, onKeyUp: this._onDropdownKeyUp, onClick: this._onDropdownClick }),
