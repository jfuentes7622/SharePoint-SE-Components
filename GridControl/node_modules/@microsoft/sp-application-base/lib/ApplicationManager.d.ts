...
export default class ApplicationManager {
     ...
     */
    startApplication<TApplication extends BaseApplication>(preloadedData: _IPreloadedData): Promise<TApplication>;
    /**
    ...
    private _initializeApplicationWithTelemetry<TApplication>(application, applicationId, qosMonitor, error);
    /**
     ...
     */
    private _initializeApplication(application, applicationId);
    private _renderApplication(application, suiteNav);
}
