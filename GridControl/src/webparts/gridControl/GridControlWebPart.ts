...
export default class GridControlWebPart extends BaseClientSideWebPart<IGridControlWebPartProps> {
  ...
  private _isGridDesignerOpen: boolean = false;
  ...
  public render(): void {
    ...
    const element: React.ReactElement<any> = React.createElement(GridControl, {
      context: this.context,
      listName: this.properties.listName || '',
  ...
  private closeGridDesigner(): void {
    this._isGridDesignerOpen = false;
    this.render();
  }

  private saveGridDesign(schemaJson: string): void {
  ...
  private getGridDesignerStatus(): string {
