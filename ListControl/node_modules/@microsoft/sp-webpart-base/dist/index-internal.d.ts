 ...
 * @public
 */
export declare abstract class BaseClientSideWebPart<TProperties> extends BaseComponent {
    /**
     ...
     * @param newValue - New value of the property.
     */
    private _onPropertyPaneFieldChanged(propertyPath, newValue);
    /**
     ...
     *
     * @param propertyPaneLifeCycleEvent - Type of PropertyPaneLifeCycleEvent.
     * @param isOrWillPaneOpen - Indicates whether the pane is already open to configure or
     *  will open now, to be configured.
     */
    private _onPropertyPaneLifeCycleEvent(propertyPaneLifeCycleEvent);
    /**
...
/* Excluded from this release type: IPropertyPaneDynamicDataProps */
...
/* Excluded from this release type: PropertyPaneDynamicData */
...
export declare enum PropertyPaneFieldType {
     ...
     */
    Link = 13,
    /* Excluded from this release type: DynamicData */
...
/* Excluded from this release type: PropertyPaneMultipleDynamicData */
 ...
 * @public
 */
export declare class WebPartContext extends BaseComponentContext {
    /**
