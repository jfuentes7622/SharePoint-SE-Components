define(["require", "exports", "tslib", "react", "./DetailsList.scss", "../../Utilities", "../DetailsList/DetailsList.types", "../DetailsList/DetailsHeader", "../DetailsList/DetailsRow", "../../FocusZone", "../../utilities/selection/index", "../../utilities/dragdrop/DragDropHelper", "../../GroupedList", "../../List", "../../utilities/decorators/withViewport", "../../utilities/groupedList/GroupedListUtility"], function (require, exports, tslib_1, React, stylesImport, Utilities_1, DetailsList_types_1, DetailsHeader_1, DetailsRow_1, FocusZone_1, index_1, DragDropHelper_1, GroupedList_1, List_1, withViewport_1, GroupedListUtility_1) {
    ...
    var DetailsList = /** @class */ (function (_super) {
        ...
        DetailsList.prototype.focusIndex = function (index, forceIntoFirstElement, measureItem) {
        ...
        DetailsList.prototype.componentDidUpdate = function (prevProps, prevState) {
            ...
            if (this.props.items !== prevProps.items &&
                ...
                !Utilities_1.elementContains(this._root.value, document.activeElement, false)) {
