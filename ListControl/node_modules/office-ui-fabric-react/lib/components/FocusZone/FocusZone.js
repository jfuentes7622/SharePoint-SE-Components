...
var FocusZone = /** @class */ (function (_super) {
            ...
            if (isInnerZoneKeystroke &&
                ...
                switch (ev.which) {
                    ...
                    case 36 /* home */:
                        ...
                        if (_this._root.value && firstChild && _this.focusElement(Utilities_1.getNextElement(_this._root.value, firstChild, true))) {
                            break;
                        }
                        return;
                    case 35 /* end */:
                        ...
                        if (_this._root.value && _this.focusElement(Utilities_1.getPreviousElement(_this._root.value, lastChild, true, true, true))) {
                            break;
                        }
                        return;
                    case 13 /* enter */:
    ...
    FocusZone.prototype.componentDidMount = function () {
        ...
        if (this._root.value) {
            ...
            var parentElement = Utilities_1.getParent(this._root.value, ALLOW_VIRTUAL_ELEMENTS);
            while (parentElement &&
    ...
    FocusZone.prototype.focus = function (forceIntoFirstElement) {
        ...
        if (this._root.value) {
            if (!forceIntoFirstElement && this._root.value.getAttribute(IS_FOCUSABLE_ATTRIBUTE) === 'true' && this._isInnerZone) {
            ...
            else if (!forceIntoFirstElement && this._activeElement && Utilities_1.elementContains(this._root.value, this._activeElement)
                ...
                return this.focusElement(Utilities_1.getNextElement(this._root.value, firstChild, true));
            }
        }
        return false;
    };
    ...
    FocusZone.prototype._moveFocus = function (isForward, getDistanceFromCenter, ev, useDefaultWrap) {
        ...
        do {
            element = (isForward ? Utilities_1.getNextElement(this._root.value, element) : Utilities_1.getPreviousElement(this._root.value, element));
            if (isBidirectional) {
                if (element) {
        ...
        if (candidateElement && candidateElement !== this._activeElement) {
            ...
            if (isForward) {
                return this.focusElement(Utilities_1.getNextElement(this._root.value, this._root.value.firstElementChild, true));
            }
            else {
                return this.focusElement(Utilities_1.getPreviousElement(this._root.value, this._root.value.lastElementChild, true, true, true));
            }
        }
        return changedFocus;
    };
