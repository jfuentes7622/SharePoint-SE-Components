    ...
    function ThemePage(props) {
        ...
        _this._colorList = function (colors, list) {
            ...
            return (React.createElement("div", null,
                React.createElement(DetailsList, { componentRef: _this._createDetailsListRef, items: colors, selectionMode: SelectionMode.none, layoutMode: DetailsListLayoutMode.fixedColumns, columns: [
                        {
                            key: 'name',
                            name: 'Name',
                            fieldName: 'name',
