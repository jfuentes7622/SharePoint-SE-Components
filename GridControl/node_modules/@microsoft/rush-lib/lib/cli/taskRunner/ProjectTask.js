...
class ProjectTask {
    ...
    _executeTask(taskCommand, writer, currentPackageDeps, resolve, reject) {
        ...
        try {
            ...
            if (isPackageUnchanged && this.isIncrementalBuildAllowed) {
                ...
                const task = Utilities_1.default.executeLifecycleCommandAsync(normalizedTaskCommand, projectFolder, this._rushConfiguration.commonTempFolder, true);
