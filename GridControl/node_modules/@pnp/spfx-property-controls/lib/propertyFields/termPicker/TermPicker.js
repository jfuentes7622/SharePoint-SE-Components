...
var TermPicker = (function (_super) {
    ...
    TermPicker.prototype.onRenderSuggestionsItem = function (term, props) {
        ...
        return (React.createElement("div", { className: PropertyFieldTermPickerHost_module_scss_1.default.termSuggestion, title: termTitle },
            ...
            React.createElement("div", { className: PropertyFieldTermPickerHost_module_scss_1.default.termSuggestionSubTitle },
                " in ",
                termParent)));
    };
    /**
    ...
    TermPicker.prototype.onFilterChanged = function (filterText, tagList) {
        return __awaiter(this, void 0, void 0, function () {
            var termsService, terms, filteredTerms, _loop_1, _i, terms_1, term;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(filterText !== "" && (this.props.allowMultipleSelections || tagList.length === 0))) return [3 /*break*/, 2];
