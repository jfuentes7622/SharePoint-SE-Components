...
var SuggestionsItem = /** @class */ (function (_super) {
    ...
    SuggestionsItem.prototype.render = function () {
        var _a = this.props, suggestionModel = _a.suggestionModel, RenderSuggestion = _a.RenderSuggestion, onClick = _a.onClick, className = _a.className, onRemoveItem = _a.onRemoveItem, isSelectedOverride = _a.isSelectedOverride;
            ...
            if (keyCode === 40 /* down */) {
                switch (currentSelectedAction) {
                    case SuggestionActionType.forceResolve:
                        ...
                        else if (_this._searchForMoreButton.value) {
                    ...
                    case SuggestionActionType.searchMore:
                        if (_this._forceResolveButton.value) {
                            newSelectedActionType = SuggestionActionType.forceResolve;
                        }
                    ...
                    case SuggestionActionType.none:
                        if (currentSuggestionIndex === -1 && _this._forceResolveButton.value) {
                            newSelectedActionType = SuggestionActionType.forceResolve;
                        }
                        break;
                }
                ...
                switch (currentSelectedAction) {
                    case SuggestionActionType.forceResolve:
                        if (_this._searchForMoreButton.value) {
                            newSelectedActionType = SuggestionActionType.searchMore;
                        }
                        else if (suggestionLength > 0) {
                            _this._refocusOnSuggestions(keyCode);
                    ...
                    case SuggestionActionType.searchMore:
                        ...
                        else if (_this._forceResolveButton.value) {
                            newSelectedActionType = SuggestionActionType.forceResolve;
                        }
                        break;
                    case SuggestionActionType.none:
                        if (currentSuggestionIndex === -1 && _this._searchForMoreButton.value) {
                            newSelectedActionType = SuggestionActionType.searchMore;
                        }
                        break;
                }
