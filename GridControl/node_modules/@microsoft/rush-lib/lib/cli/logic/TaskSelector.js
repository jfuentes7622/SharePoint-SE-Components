...
class TaskSelector {
    constructor(options) {
        ...
        this._taskRunner = new TaskRunner_1.default(this._options.isQuietMode, this._options.parallelism, this._options.changedProjectsOnly);
        try {
    ...
    _registerTask(project) {
        if (project) {
            const projectTask = new ProjectTask_1.default({
                rushProject: project,
