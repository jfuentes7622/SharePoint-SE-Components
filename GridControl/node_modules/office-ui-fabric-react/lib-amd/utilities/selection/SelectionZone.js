    ...
    var SelectionZone = /** @class */ (function (_super) {
        ...
        function SelectionZone() {
            ...
            _this._onMouseDownCapture = function (ev) {
                ...
                if (!Utilities_1.elementContains(ev.target, _this._root.value)) {
                    return;
                }
                var target = ev.target;
                while (target !== _this._root.value) {
        ...
        SelectionZone.prototype.componentDidMount = function () {
            var win = Utilities_1.getWindow(this._root.value);
            var scrollElement = Utilities_1.findScrollableParent(this._root.value);
