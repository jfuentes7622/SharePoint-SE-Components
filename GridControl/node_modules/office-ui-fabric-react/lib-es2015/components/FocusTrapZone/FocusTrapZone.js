...
var FocusTrapZone = /** @class */ (function (_super) {
    ...
    function FocusTrapZone() {
        ...
        _this._onKeyboardHandler = function (ev) {
            ...
            var _firstFocusableChild = getFirstFocusable(_this._root.value, _this._root.value.firstChild, true);
            var _lastFocusableChild = getLastTabbable(_this._root.value, _this._root.value.lastChild, true);
    ...
    FocusTrapZone.prototype.focus = function () {
        ...
        if (this._root.value) {
            if (focusSelector) {
                ...
                _firstFocusableChild = getNextElement(this._root.value, this._root.value.firstChild, true, false, false, true);
            }
        }
