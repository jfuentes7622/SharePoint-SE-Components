...
export default class Placeholder {
    ...
    /**
     * Import all placeholder entries from a different placeholder.
     * @param sourcePlaceholder - Placeholder to import entries from.
     */
    importEntries(sourcePlaceholder: Placeholder): void;
     ...
     */
    private _addContentDiv(domElement, sequence);
}
