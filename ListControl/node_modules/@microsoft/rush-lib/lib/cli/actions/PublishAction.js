...
class PublishAction extends BaseRushAction_1.BaseRushAction {
    ...
    run() {
        ...
        if (this._regenerateChangelogs.value) {
            ...
            ChangelogGenerator_1.default.regenerateChangelogs(allPackages, this.rushConfiguration);
            return Promise.resolve();
        }
        this._validate();
    ...
    _npmPublish(packageName, packagePath) {
        ...
        if (this.rushConfiguration.projectsByName.get(packageName).shouldPublish) {
            ...
            PublishUtilities_1.default.execCommand(!!this._publish.value, this.rushConfiguration.packageManagerToolFilename, args, packagePath, env);
        }
    }
    ...
    _npmPack(packageName, project) {
        ...
        PublishUtilities_1.default.execCommand(!!this._publish.value, this.rushConfiguration.packageManagerToolFilename, args, project.projectFolder, env);
