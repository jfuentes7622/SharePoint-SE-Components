...
var ContextualMenu = /** @class */ (function (_super) {
    ...
    ContextualMenu.prototype._renderSplitButton = function (item, classNames, index, focusableElementIndex, totalItemCount, hasCheckmarks, hasIcons) {
        ...
        return (React.createElement("div", { ref: function (el) {
            ...
            }, role: 'button', "aria-labelledby": item.ariaLabel, className: classNames.splitContainer, "aria-disabled": this._isItemDisabled(item), "aria-haspopup": true, "aria-describedby": item.ariaDescription, "aria-checked": item.isChecked || item.checked, "aria-posinset": focusableElementIndex + 1, "aria-setsize": totalItemCount, onMouseEnter: this._onItemMouseEnter.bind(this, tslib_1.__assign({}, item, { subMenuProps: null, items: null })), onMouseLeave: this._onMouseItemLeave.bind(this, tslib_1.__assign({}, item, { subMenuProps: null, items: null })), onMouseMove: this._onItemMouseMove.bind(this, tslib_1.__assign({}, item, { subMenuProps: null, items: null })), onKeyDown: this._onSplitContainerItemKeyDown.bind(this, item), onClick: this._executeItemClick.bind(this, item), tabIndex: 0, "data-is-focusable": true },
    ...
    ContextualMenu.prototype._renderSplitPrimaryButton = function (item, classNames, index, hasCheckmarks, hasIcons) {
        ...
        return React.createElement('button', getNativeProps(itemProps, buttonProperties), React.createElement(ChildrenRenderer, { item: itemProps, classNames: classNames, index: index, onCheckmarkClick: hasCheckmarks ? this._onItemClick : undefined, hasIcons: hasIcons }));
    };
