...
var BasePicker = /** @class */ (function (_super) {
    ...
    BasePicker.prototype.renderSuggestions = function () {
        ...
        return this.state.suggestionsVisible && this.input ? (React.createElement(Callout, { isBeakVisible: false, gapSpace: 5, target: this.input.value ? this.input.value.inputElement : undefined, onDismiss: this.dismissSuggestions, directionalHint: 4 /* bottomLeftEdge */, directionalHintForRTL: 6 /* bottomRightEdge */ },
    ...
    BasePicker.prototype._onValidateInput = function () {
        if (this.props.onValidateInput && this.input.value && this.props.onValidateInput(this.input.value.value) !== ValidationState.invalid && this.props.createGenericItem) {
