...
var TermSet = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.props.termsService.getAllTerms(this.props.termset._ObjectIdentity_)];
                    case 1:
                        terms = _a.sent();
                        if (terms !== null) {
                            this.setState({
    ...
    TermSet.prototype.render = function () {
            ...
            if (this.state.loaded) {
                if (this.state.terms.length > 0) {
                    termElm = (React.createElement("div", { style: styleProps }, this.state.terms.map(function (term) {
                        return React.createElement(Term_1.default, { key: term.Id, term: term, termset: _this.props.termset.Id, activeNodes: _this.props.activeNodes, changedCallback: _this.props.changedCallback, multiSelection: _this.props.multiSelection });
                    })));
                }
                else {
        ...
        return (React.createElement("div", null,
            React.createElement("div", { className: PropertyFieldTermPickerHost_module_scss_1.default.listItem + " " + PropertyFieldTermPickerHost_module_scss_1.default.termset, onClick: this._handleClick },
