...
class RushCommandLineParser extends ts_command_line_1.CommandLineParser {
    ...
    _execute() {
        try {
            if (this.rushConfiguration) {
                this.telemetry = new Telemetry_1.default(this.rushConfiguration);
            }
    ...
    _populateActions() {
        try {
            ...
            if (rushJsonFilename) {
                this.rushConfiguration = RushConfiguration_1.default.loadFromConfigurationFile(rushJsonFilename);
