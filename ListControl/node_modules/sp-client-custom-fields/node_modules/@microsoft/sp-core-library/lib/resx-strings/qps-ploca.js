define([], function() {
  var strings = {
    "_gIErrcTokcw+/VVwa+ReIA": {
      ...
      "invalidGuidStringError": "***İŉvȃłĩď ĢŪĨĎ şťŗįňĝ: \"{0}\"",
      ...
      "invalidVersionStringError": "***İŋvăļıď vēřşĭőŋ şŧŕĭŉġ: \"{0}\"",
      ...
      "serviceScopeConsumingBeforeFinished": "***Ċäņƞŏť ćŏňŝūmȅ śēřvīċĕš ƃėċâųšĕ ťĥȇ šċơƿė īş ňőŧ ƒīŉīšĥĕď ȳěţ",
      "serviceScopeConsumingDuringAutoCreation": "***Čäƞňơţ čōńśũmȇ śĕŕvįćēş ďűŗĩňġ ŜȇřvĭċĕŞċōƥě ãűţŏċŕȇǻŧįōƞ",
      "serviceScopeAlreadyFinishedError": "***Ŧħȇ ŞěŗvıĉēŜĉōƿȇ ĭŝ âļřĕăďɏ ƒįŉĩšĥȅđ",
      "serviceScopeProvideServiceAfterFinishedError": "***Ĉăņƞơţ ŕȇġĭšŧěř šėřvıċȅ ƀĕċåũśę ţĥĕ ŝċŏƿē įš ãłŕȅáďɏ ƒĭňışħęď",
      "serviceScopeProvideServiceThatAlreadyExists": "***Ŧħę śȇřvĩĉȇ ĸęȳ \"{0}\" ĥàś âļřȅàďƴ Ƃĕȇŉ řėĝįśťėřȇď įņ ťĥĩŝ šĉōƿė",
