...
function normalizeFetchBatchSize(value) {
    var parsed = parseInt(String(value === undefined || value === null ? '' : value), 10);
...
var ListControlWebPart = (function (_super) {
    ...
    Object.defineProperty(ListControlWebPart.prototype, "metadata", {
        get: function () {
    ...
    ListControlWebPart.prototype.getPropertyDefinitions = function () {
        return [
            {
                id: 'instanceName',
    ...
    ListControlWebPart.prototype.getPropertyValue = function (propertyId) {
    ...
    ListControlWebPart.prototype.render = function () {
        ...
        var element = React.createElement(ListControl_1.ListControl, {
            context: this.context,
            listName: this.properties.listName || '',
    ...
    ListControlWebPart.prototype.onInit = function () {
        var _this = this;
    ...
    ListControlWebPart.prototype.onPropertyPaneConfigurationStart = function () {
    ...
    ListControlWebPart.prototype.isLookupTypeField = function (internalName) {
        var typeName = this._fieldTypeByInternalName[internalName || ''];
        return typeName === 'lookup' || typeName === 'lookupmulti';
    };
    ListControlWebPart.prototype.supportsFilterFieldValue = function (internalName) {
    ...
    ListControlWebPart.prototype.isMultiFilterField = function (internalName) {
        var typeName = String(this._fieldTypeByInternalName[internalName || ''] || '').toLowerCase();
        return typeName === 'multichoice' || typeName === 'lookupmulti';
    };
    ListControlWebPart.prototype.getSelectedFilterFieldValues = function () {
    ...
    ListControlWebPart.prototype.createFilterMultiValuePicker = function (options) {
        var _this = this;
    ...
    ListControlWebPart.prototype.handleLoadFilterLookupItems = function () {
        return __awaiter(this, void 0, void 0, function () {
    ...
    ListControlWebPart.prototype.handleApplyFilterLookupPick = function () {
    ...
    ListControlWebPart.prototype.handleLoadConditionalStyleLookupItems = function () {
        return __awaiter(this, void 0, void 0, function () {
            var fieldName, listId, _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
    ...
    ListControlWebPart.prototype.handleApplyConditionalStyleLookupPick = function () {
    ...
    ListControlWebPart.prototype.createPropertyPanePageTitle = function (key, title) {
        return PropertyPaneCustomField_1.PropertyPaneCustomField({
            key: key,
            onRender: function (domElement) {
    ...
    ListControlWebPart.prototype.createFilterExpressionHelpField = function () {
        var _this = this;
    ...
    ListControlWebPart.prototype.createConditionalStyleExpressionHelpField = function () {
        var _this = this;
    ...
    ListControlWebPart.prototype.handleColorPropertyChange = function (propertyPath, oldValue, newValue) {
                    ...
                    groups: [
                        ...
                        },
                        {
                            ...
                            groupFields: [
                                ...
                                sp_webpart_base_1.PropertyPaneButton('openListDesigner', {
                                ...
                                sp_webpart_base_1.PropertyPaneLabel('listDesignerStatus', {
                                ...
                                sp_webpart_base_1.PropertyPaneTextField('fetchBatchSize', {
                        ...
                        },
                        {
                            ...
                            groupFields: [
                                ...
                                sp_webpart_base_1.PropertyPaneCheckbox('showEdit', {
                                    text: strings.PropShowEditLabel,
                                    checked: this.properties.showEdit !== false
                                }),
                                sp_webpart_base_1.PropertyPaneCheckbox('showView', {
                        ...
                        },
                        {
                            ...
                            groupFields: [
                            ...
                            ].concat((this.properties.dateDisplayFormat === 'custom' ? [
                                sp_webpart_base_1.PropertyPaneTextField('dateCustomFormat', {
                                ...
                                sp_webpart_base_1.PropertyPaneDropdown('dateCustomFormatCase', {
                                ...
                                sp_webpart_base_1.PropertyPaneTextField('timeCustomFormat', {
                                ...
                                sp_webpart_base_1.PropertyPaneDropdown('timeCustomFormatCase', {
                                    label: strings.PropCustomFormatTextCaseLabel,
                                    options: [
                                        { key: 'default', text: strings.PropCustomFormatTextCaseDefault },
                                        { key: 'upper', text: strings.PropCustomFormatTextCaseUpper },
                    ...
                    groups: [
                        ...
                        },
                        {
                            ...
                            groupFields: [
                                ...
                                PropertyFieldColorPicker_1.PropertyFieldColorPicker('conditionalStyleBorderColor', {
                                ...
                                sp_webpart_base_1.PropertyPaneDropdown('conditionalStyleBorderStyle', {
                                ...
                                sp_webpart_base_1.PropertyPaneSlider('conditionalStyleBorderWidth', {
                                ...
                                sp_webpart_base_1.PropertyPaneDropdown('conditionalStyleCornerStyle', {
                                ...
                                sp_webpart_base_1.PropertyPaneSlider('conditionalStyleBorderRadius', {
    ...
    ListControlWebPart.prototype.getWebPartVersion = function () {
    ...
    ListControlWebPart.prototype.getFontFamilyOptions = function () {
        return [
            { key: '', text: 'Default' },
    ...
    ListControlWebPart.prototype.getFontStyleOptions = function () {
        return [
            { key: 'normal', text: strings.PropFontStyleNormal },
            { key: 'italic', text: strings.PropFontStyleItalic },
            { key: 'oblique', text: strings.PropFontStyleOblique },
    ...
    ListControlWebPart.prototype.getTextAlignOptions = function () {
        return [
            { key: 'left', text: strings.PropTextAlignLeft },
            { key: 'center', text: strings.PropTextAlignCenter },
            { key: 'right', text: strings.PropTextAlignRight }
    ...
    ListControlWebPart.prototype.validateJsonText = function (raw, expectedShape) {
    ...
    ListControlWebPart.prototype.parseFilterJsonArray = function (raw) {
        var source = String(raw || '').trim();
        if (!source) {
            return [];
        }
    ...
    ListControlWebPart.prototype.handleValidateFilterJson = function () {
        var result = this.validateJsonText(this.properties.filterJson, 'array');
        this._filterJsonValidationMessage = result.message;
        this.context.propertyPane.refresh();
    };
    ListControlWebPart.prototype.handleAddFilterDesignerCondition = function () {
        try {
    ...
    ListControlWebPart.prototype.handleLoadSelectedFilterCondition = function () {
        try {
    ...
    ListControlWebPart.prototype.handleUpdateSelectedFilterCondition = function () {
        try {
            var index = parseInt(String(this.properties.filterDesignerSelectedIndex || ''), 10);
            var existing = this.parseFilterJsonArray(this.properties.filterJson);
            if (isNaN(index) || index < 0 || index >= existing.length) {
    ...
    ListControlWebPart.prototype.handleRemoveSelectedFilterCondition = function () {
        try {
            var index = parseInt(String(this.properties.filterDesignerSelectedIndex || ''), 10);
            var existing = this.parseFilterJsonArray(this.properties.filterJson);
            if (isNaN(index) || index < 0 || index >= existing.length) {
    ...
    ListControlWebPart.prototype.handleResetFilterJson = function () {
    ...
    ListControlWebPart.prototype.isSupportedFilterExpression = function (value) {
    ...
    ListControlWebPart.prototype.parseConditionalStyleJsonArray = function (raw) {
        var source = String(raw || '').trim();
        if (!source) {
            return [];
        }
    ...
    ListControlWebPart.prototype.handleValidateConditionalStyleJson = function () {
    ...
    ListControlWebPart.prototype.parseConditionalStylePriority = function (raw) {
    ...
    ListControlWebPart.prototype.createConditionalStyleEntryFromDesigner = function () {
    ...
    ListControlWebPart.prototype.resetConditionalStyleDesigner = function () {
    ...
    ListControlWebPart.prototype.handleNewConditionalStyle = function () {
    ...
    ListControlWebPart.prototype.handleAddConditionalStyleCondition = function () {
        try {
    ...
    ListControlWebPart.prototype.handleLoadSelectedConditionalStyleCondition = function () {
        try {
    ...
    ListControlWebPart.prototype.handleUpdateSelectedConditionalStyleCondition = function () {
        try {
            var index = parseInt(String(this.properties.conditionalStyleSelectedIndex || ''), 10);
            var existing = this.parseConditionalStyleJsonArray(this.properties.conditionalStyleJson);
            if (isNaN(index) || index < 0 || index >= existing.length) {
    ...
    ListControlWebPart.prototype.handleRemoveSelectedConditionalStyleCondition = function () {
        try {
            var index = parseInt(String(this.properties.conditionalStyleSelectedIndex || ''), 10);
            var existing = this.parseConditionalStyleJsonArray(this.properties.conditionalStyleJson);
            if (isNaN(index) || index < 0 || index >= existing.length) {
    ...
    ListControlWebPart.prototype.handleMoveConditionalStyleConditionUp = function () {
        try {
            var index = parseInt(String(this.properties.conditionalStyleSelectedIndex || ''), 10);
            var existing = this.parseConditionalStyleJsonArray(this.properties.conditionalStyleJson);
            if (isNaN(index) || index <= 0 || index >= existing.length) {
    ...
    ListControlWebPart.prototype.handleMoveConditionalStyleConditionDown = function () {
        try {
            var index = parseInt(String(this.properties.conditionalStyleSelectedIndex || ''), 10);
            var existing = this.parseConditionalStyleJsonArray(this.properties.conditionalStyleJson);
    ...
    ListControlWebPart.prototype.handleResetConditionalStyleJson = function () {
    ...
    ListControlWebPart.prototype.initializeDynamicDataSource = function () {
    ...
    ListControlWebPart.prototype.notifyDynamicSourceChanged = function () {
    ...
    ListControlWebPart.prototype.notifyDynamicData = function (propertyId) {
        if (!this._dynamicDataSourceManager) {
            return;
        }
    ...
    ListControlWebPart.prototype.handleSelectionChange = function (itemId, mode) {
    ...
    ListControlWebPart.prototype.openListDesigner = function () {
    ...
    ListControlWebPart.prototype.closeListDesigner = function () {
        this._isListDesignerOpen = false;
        this.render();
    };
    ListControlWebPart.prototype.saveListDesign = function (columns, groupingJson) {
    ...
    ListControlWebPart.prototype.getListDesignerStatus = function () {
    ...
    ListControlWebPart.prototype.logDiagnostic = function (message) {
        if (this.properties.enableDiagnostics === false) {
            return;
        }
        console.log('[ListControlWebPart] ' + message);
    };
    return ListControlWebPart;
}(sp_webpart_base_1.BaseClientSideWebPart));
exports.default = ListControlWebPart;

//# sourceMappingURL=ListControlWebPart.js.map
