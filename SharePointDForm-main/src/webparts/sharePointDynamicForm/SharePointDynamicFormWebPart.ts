...
export default class SharePointDynamicFormWebPart extends BaseClientSideWebPart<ISharePointDynamicFormWebPartProps> {
  ...
  private isListControlSourceMetadata(metadata: any): boolean {
    ...
    return componentId === SharePointDynamicFormWebPart.LIST_CONTROL_COMPONENT_ID || alias === SharePointDynamicFormWebPart.LIST_CONTROL_ALIAS.toLowerCase();
  }
  ...
  protected getPropertyPaneConfiguration(): IPropertyPaneConfiguration {
    ...
    var useDynamicItemAsItemId = this.properties.useDynamicItemIdAsItemId !== false;
    var dynamicTargetFieldOptions = this._listFields.length > 0 ? this._listFields : [{ key: '', text: strings.PropDynamicTargetFieldNone }];
