...
import { autobind, DelayedRender, BaseComponent, getId, css, getNativeProps, inputProperties, textAreaProperties, createRef } from '../../Utilities';
...
var TextField = /** @class */ (function (_super) {
    ...
    function TextField(props) {
        ...
        _this._latestValue = props.value || props.defaultValue || '';
        _this.state = {
    ...
    TextField.prototype._onRenderLabel = function (props) {
        ...
        if (label) {
            return (React.createElement(Label, { htmlFor: this._id }, label));
        }
        return null;
    };
    // @deprecated
    ...
    TextField.prototype._adjustInputHeight = function () {
        if (this._textElement.value && this.props.autoAdjustHeight && this.props.multiline) {
            var textField = this._textElement.value;
    ...
    tslib_1.__decorate([
        autobind
    ], TextField.prototype, "_onRenderLabel", null);
    return TextField;
}(BaseComponent));
export { TextField };
