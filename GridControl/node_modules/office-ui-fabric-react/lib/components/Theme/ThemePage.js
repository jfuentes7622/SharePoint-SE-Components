    ...
    function ThemePage(props) {
        ...
        _this._colorList = function (colors, list) {
            ...
            return (React.createElement("div", null,
                React.createElement(DetailsList_1.DetailsList, { componentRef: _this._createDetailsListRef, items: colors, selectionMode: Selection_1.SelectionMode.none, layoutMode: DetailsList_1.DetailsListLayoutMode.fixedColumns, columns: [
                        {
                            key: 'name',
                            name: 'Name',
                            fieldName: 'name',
        ...
        _this._createDetailsListRef = function (component) {
            _this._list = component;
        };
