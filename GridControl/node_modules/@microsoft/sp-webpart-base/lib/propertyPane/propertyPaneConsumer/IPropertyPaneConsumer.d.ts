...
export interface IPropertyPaneConsumer {
    /**
     * Property is used to change the property pane interaction from Reactive to NonReactive.
     *
     * @remarks
     ...
     *
     * @internalremarks
     * Property name should change when the BaseClientSideWebPart implements IPropertyPaneControl
     * (as BaseClientSideWebPart has that as protected and not public/internal)
     */
    ...
    */
    ...
    /**
     * These APIs should be removed when we decouple web part manager and property pane controller.
     */
