...
var Term = (function (_super) {
    ...
    Term.prototype.render = function () {
        ...
        return (React.createElement("div", { className: PropertyFieldTermPickerHost_module_scss_1.default.listItem + " " + PropertyFieldTermPickerHost_module_scss_1.default.term, style: styleProps },
            React.createElement(Checkbox_1.Checkbox, { checked: this.state.selected, disabled: this.props.term.IsDeprecated, className: this.props.term.IsDeprecated ? PropertyFieldTermPickerHost_module_scss_1.default.termDisabled : PropertyFieldTermPickerHost_module_scss_1.default.termEnabled, label: this.props.term.Name, onChange: this._handleChange })));
    };
    return Term;
}(React.Component));
