define(["require", "exports", "tslib", "react", "../../Utilities", "../../FocusZone", "../../Callout", "../../utilities/selection/index", "./Suggestions/Suggestions", "./Suggestions/SuggestionsController", "./BasePicker.types", "../Autofill/index", "./BasePicker.scss"], function (require, exports, tslib_1, React, Utilities_1, FocusZone_1, Callout_1, index_1, Suggestions_1, SuggestionsController_1, BasePicker_types_1, index_2, stylesImport) {
    ...
    var BasePicker = /** @class */ (function (_super) {
        ...
        function BasePicker(basePickerProps) {
            ...
            _this.onInputFocus = function (ev) {
                ...
                if (!_this.state.isFocused) {
                    ...
                    if (_this.input.value && _this.input.value.value === '' && _this.props.onEmptyInputFocus) {
                    ...
                    else if (_this.input.value && _this.input.value.value) {
                        _this.setState({
                            isMostRecentlyUsedVisible: false,
                            suggestionsVisible: true
                        });
            ...
            _this.onKeyDown = function (ev) {
                ...
                switch (keyCode) {
                    ...
                    case 9 /* tab */:
                    case 13 /* enter */:
                        if (_this.suggestionElement.value && _this.suggestionElement.value.hasSuggestedActionSelected()) {
                            _this.suggestionElement.value.executeSelectedAction();
                        }
                    ...
                    case 46 /* del */:
                        if (!_this.props.disabled) {
                            if (_this.input.value && ev.target === _this.input.value.inputElement && _this.state.suggestionsVisible && _this.suggestionStore.currentIndex !== -1) {
                                if (_this.props.onRemoveSuggestion) {
                        ...
                        break;
                    case 38 /* up */:
                        if (_this.input.value && ev.target === _this.input.value.inputElement && _this.state.suggestionsVisible) {
                            if (_this.suggestionElement.value && _this.suggestionElement.value.tryHandleKeyDown(keyCode, _this.suggestionStore.currentIndex)) {
                                ev.preventDefault();
                                ev.stopPropagation();
                            }
                            else {
                                if (_this.suggestionElement.value && _this.suggestionElement.value.hasSuggestedAction() && _this.suggestionStore.currentIndex === 0) {
                                    ev.preventDefault();
                                    ev.stopPropagation();
                                    _this.suggestionElement.value.focusAboveSuggestions();
                    ...
                    case 40 /* down */:
                        if (_this.input.value && ev.target === _this.input.value.inputElement && _this.state.suggestionsVisible) {
                            if (_this.suggestionElement.value && _this.suggestionElement.value.tryHandleKeyDown(keyCode, _this.suggestionStore.currentIndex)) {
                                ...
                                if (_this.suggestionElement.value && _this.suggestionElement.value.hasSuggestedAction() && (_this.suggestionStore.currentIndex + 1) === _this.suggestionStore.suggestions.length) {
                                    ev.preventDefault();
                                    ev.stopPropagation();
                                    _this.suggestionElement.value.focusBelowSuggestions();
                                    _this.suggestionStore.deselectAllSuggestions();
                                    _this.forceUpdate();
                                }
                                else {
            ...
            _this.onGetMoreResults = function () {
                _this.setState({
                    ...
                    if (_this.props.onGetMoreResults && _this.input.value) {
                        var suggestions = _this.props.onGetMoreResults(_this.input.value.value, _this.state.items);
        ...
        BasePicker.prototype.renderSuggestions = function () {
            ...
            return this.state.suggestionsVisible && this.input ? (React.createElement(Callout_1.Callout, { isBeakVisible: false, gapSpace: 5, target: this.input.value ? this.input.value.inputElement : undefined, onDismiss: this.dismissSuggestions, directionalHint: 4 /* bottomLeftEdge */, directionalHintForRTL: 6 /* bottomRightEdge */ },
                React.createElement(TypedSuggestion, tslib_1.__assign({ onRenderSuggestion: this.props.onRenderSuggestionsItem, onSuggestionClick: this.onSuggestionClick, onSuggestionRemove: this.onSuggestionRemove, suggestions: this.suggestionStore.getSuggestions(), ref: this.suggestionElement, onGetMoreResults: this.onGetMoreResults, moreSuggestionsAvailable: this.state.moreSuggestionsAvailable, isLoading: this.state.suggestionsLoading, isSearching: this.state.isSearching, isMostRecentlyUsedVisible: this.state.isMostRecentlyUsedVisible, isResultsFooterVisible: this.state.isResultsFooterVisible, refocusSuggestions: this.refocusSuggestions }, this.props.pickerSuggestionsProps)))) : (null);
        };
        ...
        BasePicker.prototype.resetFocus = function (index) {
            ...
            if (items.length && index >= 0) {
                var newEl = this.root.value && this.root.value.querySelectorAll('[data-selection-index]')[Math.min(index, items.length - 1)];
        ...
        BasePicker.prototype.onSuggestionSelect = function () {
            if (this.suggestionStore.currentSuggestion) {
                var currentValue = this.input.value ? this.input.value.value : '';
        ...
        BasePicker.prototype._onValidateInput = function () {
            if (this.props.onValidateInput && this.input.value && this.props.onValidateInput(this.input.value.value) !== BasePicker_types_1.ValidationState.invalid && this.props.createGenericItem) {
                var itemToConvert = this.props.createGenericItem(this.input.value.value, this.props.onValidateInput(this.input.value.value));
