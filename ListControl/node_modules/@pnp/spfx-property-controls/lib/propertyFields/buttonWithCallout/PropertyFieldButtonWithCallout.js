...
var PropertyFieldButtonWithCalloutBuilder = (function () {
    ...
    PropertyFieldButtonWithCalloutBuilder.prototype._render = function (elem, context, changeCallback) {
        var props = _.omit(this.properties, ['buttonType']);
        //
        // PropertyPaneButtonType is not assignable to ButtonType
        //
        var buttonTypeString = office_ui_fabric_react_1.ButtonType[this.properties.buttonType];
        var buttonType = office_ui_fabric_react_1.ButtonType[buttonTypeString];
        var element = React.createElement(PropertyFieldButtonWithCalloutHost_1.default, __assign({}, props, { buttonType: buttonType }));
