define(["require", "exports", "tslib", "react", "./MarqueeSelection.scss", "../../Utilities"], function (require, exports, tslib_1, React, stylesImport, Utilities_1) {
    ...
    var MarqueeSelection = /** @class */ (function (_super) {
        ...
        function MarqueeSelection(props) {
            ...
            _this._onMouseDown = function (ev) {
                ...
                if (!_this._isTouch && isEnabled && !_this._isDragStartInSelection(ev) && (!onShouldStartSelection || onShouldStartSelection(ev))) {
                    if (_this._scrollableSurface && ev.button === 0 && _this._root.value) {
                        ...
                        _this._autoScroll = new Utilities_1.AutoScroll(_this._root.value);
                        _this._scrollTop = _this._scrollableSurface.scrollTop;
                        _this._rootRect = _this._root.value.getBoundingClientRect();
        ...
        MarqueeSelection.prototype.componentDidMount = function () {
            this._scrollableParent = Utilities_1.findScrollableParent(this._root.value);
            ...
            var hitTarget = this.props.isDraggingConstrainedToRoot ? this._root.value : this._scrollableSurface;
        ...
        MarqueeSelection.prototype._isDragStartInSelection = function (ev) {
            ...
            var allElements = this._root.value.querySelectorAll('[data-selection-index]');
