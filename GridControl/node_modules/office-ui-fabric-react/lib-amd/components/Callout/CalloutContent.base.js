define(["require", "exports", "tslib", "react", "../../Utilities", "../../utilities/positioning", "../../Popup", "../../Utilities", "../../Styling"], function (require, exports, tslib_1, React, Utilities_1, positioning_1, Popup_1, Utilities_2, Styling_1) {
    ...
    var CalloutContentBase = /** @class */ (function (_super) {
        ...
        function CalloutContentBase(props) {
            ...
            _this._setInitialFocus = function () {
                if (_this.props.setInitialFocus && !_this._didSetInitialFocus && _this.state.positions && _this._calloutElement.value) {
                    ...
                    _this._async.requestAnimationFrame(function () { return Utilities_1.focusFirstChild(_this._calloutElement.value); });
                }
            };
        ...
        CalloutContentBase.prototype._dismissOnLostFocus = function (ev) {
            ...
            var clickedOutsideCallout = this._hostElement.value && !Utilities_1.elementContains(this._hostElement.value, target);
