define(["require", "exports", "tslib", "react", "../../Callout", "../../Label", "../../Checkbox", "../../Button", "../Autofill/index", "../../Utilities", "../../utilities/selectableOption/SelectableOption.types", "./ComboBox.styles", "./ComboBox.classNames"], function (require, exports, tslib_1, React, Callout_1, Label_1, Checkbox_1, Button_1, index_1, Utilities_1, SelectableOption_types_1, ComboBox_styles_1, ComboBox_classNames_1) {
    "use strict";
    ...
    var ComboBox = /** @class */ (function (_super) {
        ...
        function ComboBox(props) {
            ...
            _this.focus = function (shouldOpenOnFocus) {
                if (_this._autofill.value) {
                    _this._autofill.value.focus();
            ...
            _this._onUpdateValueInAutofillWillReceiveProps = function () {
                var comboBox = _this._autofill.value;
                if (!comboBox) {
                    return null;
                }
            ...
            _this._select = function () {
                if (_this._autofill.value && _this._autofill.value.inputElement) {
                    _this._autofill.value.inputElement.select();
                }
            ...
            _this._onBlur = function (event) {
                ...
                if (event.relatedTarget &&
                    (_this._root.value && _this._root.value.contains(event.relatedTarget) ||
                        _this._comboBoxMenu.value && _this._comboBoxMenu.value.contains(event.relatedTarget))) {
            ...
            _this._onRenderContainer = function (props) {
                ...
                return (React.createElement(Callout_1.Callout, tslib_1.__assign({ isBeakVisible: false, gapSpace: 0, doNotLayer: false, directionalHint: 4 /* bottomLeftEdge */, directionalHintFixed: true }, calloutProps, { className: Utilities_1.css(_this._classNames.callout, calloutProps ? calloutProps.className : undefined), target: _this._comboBoxWrapper.value, onDismiss: _this._onDismiss, onScroll: _this._onScroll, setInitialFocus: false, calloutWidth: useComboBoxAsMenuWidth && _this._comboBoxWrapper.value ?
                        _this._comboBoxWrapper.value.clientWidth + 2
                        : dropdownWidth }),
            ...
            _this._onDismiss = function () {
                ...
                if (_this._autofill.value && _this._focusInputAfterClose) {
                    _this._autofill.value.focus();
                }
            };
            /**
            ...
            _this._onInputKeyDown = function (ev) {
                ...
                var _b = _this.state, isOpen = _b.isOpen, currentOptions = _b.currentOptions, currentPendingValueValidIndexOnHover = _b.currentPendingValueValidIndexOnHover, selectedIndices = _b.selectedIndices;
                if (disabled) {
            ...
            _this._onAutofillClick = function () {
                if (_this.props.allowFreeform) {
                    _this.focus(_this.state.isOpen);
                }
                else {
        ...
        ComboBox.prototype.render = function () {
            ...
            var _g = this.state, isOpen = _g.isOpen, selectedIndices = _g.selectedIndices, focused = _g.focused, suggestedDisplayValue = _g.suggestedDisplayValue;
        ...
        ComboBox.prototype._processInputChangeWithoutFreeform = function (updatedValue) {
            var _this = this;
            var _a = this.state, currentPendingValue = _a.currentPendingValue, currentPendingValueValidIndex = _a.currentPendingValueValidIndex, currentOptions = _a.currentOptions, selectedIndices = _a.selectedIndices;
            if (this.props.autoComplete === 'on') {
        ...
        ComboBox.prototype._getPendingSelectedIndex = function (includeCurrentPendingValue) {
            var _a = this.state, currentPendingValueValidIndexOnHover = _a.currentPendingValueValidIndexOnHover, currentPendingValueValidIndex = _a.currentPendingValueValidIndex, currentPendingValue = _a.currentPendingValue, selectedIndices = _a.selectedIndices;
        ...
        ComboBox.prototype._scrollIntoView = function () {
            ...
            var _b = this.state, currentPendingValueValidIndex = _b.currentPendingValueValidIndex, currentPendingValue = _b.currentPendingValue, selectedIndices = _b.selectedIndices;
            if (onScrollToItem) {
                ...
                if (scrollSelectedToTop) {
                    ...
                    if (this._comboBoxMenu.value && this._comboBoxMenu.value.offsetParent) {
                        var scrollableParentRect = this._comboBoxMenu.value.offsetParent.getBoundingClientRect();
                        var selectedElementRect = this._selectedElement.value.offsetParent.getBoundingClientRect();
        ...
        ComboBox.prototype._resetSelectedIndex = function () {
            var _a = this.state, selectedIndices = _a.selectedIndices, currentOptions = _a.currentOptions;
        ...
        ComboBox.prototype._setPendingInfoFromIndexAndDirection = function (index, searchDirection) {
            var _a = this.state, isOpen = _a.isOpen, currentOptions = _a.currentOptions;
